...
class UpdateBlog extends React.Component{
    ...
    componentDidMount() {
        BlogService.getBlogById(this.state.id).then((resp) => {
            let blog = resp.data;
            this.setState({
                title:blog.title,
    ...
    handleSubmit(event){
        ...
        BlogService.updateBlog(blog,this.state.id).then(resp =>{
                    ...
                    <form className="form-horizontal">
                        ...
                        <div className="form-group">
                            <div className="col-sm-offset-2 col-sm-10">
                                <button id="submit" name="submit" onClick={this.handleSubmit} className={"btn btn-primary"}>Update</button>
                            </div>
                            <div className="form-group">
                            </div>
                            <div className="col-sm-offset-2 col-sm-10">
